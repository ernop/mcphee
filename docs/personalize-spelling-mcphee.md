...
A Firefox add-on that puts personalized-spelling on form inputs you have
allowed — and on no others.
...
- You choose **certain form inputs on certain sites**. personalized-spelling
  is not watching the web. It may see and know about a form only after you
  allow that form.
- Once you opt in, that form gets the **regular personalized-spelling
  spellcheck** — the same checks, the same one-click fixes, the same
  personal dictionary. Nothing else about the site changes. Submit is not
...
- It docks beside the form you allowed (the default). A little **+** on
  ...
  **+**. You can switch that site to a side-of-window sidebar instead;
  personalized-spelling remembers the choice per site.
- It does personalized-spelling's **traditional highlighting** on the words
  in the form.
...
- Add-on name: `personalized-spelling`
- Allow a form: **Allow personalized-spelling on a form on this page**
- While choosing: **Click the form input personalized-spelling may see (Esc cancels)**
- After allowing: **Allowed — personalized-spelling will check this form.**
